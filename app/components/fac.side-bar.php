    ...
    <div class="sidebar-inner slimscrollleft">
        <div id="sidebar-menu">
            <ul>
                ...
                <li><a href="<?php echo Url_dir . 'master list'; ?>" class="waves-effect  <?php echo $Active_Master_List ?>"><i class="dripicons-blog"></i>
                        <span>Master list </span></a>
                </li>
                <li><a href="<?php echo Url_dir . 'class.schedule'; ?>" class="waves-effect  <?php echo $class_sched ?>"><i class="dripicons-to-do"></i><span>
                            Class shedule</span></a></li>


                <li class="menu-title">Report & Grades</li>
                <li><a href="<?php echo Url_dir . 'grade'; ?>" class="waves-effect  <?php echo $Active_grade ?>"><i class="fas fa-file-alt"></i><span>
                            Grades</span></a>
                </li>
            </ul>
        </div>
