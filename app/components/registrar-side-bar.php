    ...
    <div class="sidebar-inner slimscrollleft">
        <div id="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="<?php echo Url_dir . 'subject'; ?>" class="waves-effect  <?php echo $Active_sub ?>"><i class="fas fa-book"></i><span>
                            Subjects</span></a>
                </li>
                <li>
                    <a href="<?php echo Url_dir . 'S-A-L'; ?>" class="waves-effect  <?php echo $admin_active_sal ?>"><i class="fas fa-user-clock"></i><span>
                            Schedules and Loads</span></a>
                </li>
