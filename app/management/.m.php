...
if ($current_file == '.m.php') {
    define('ACTIVE_MANAGEMENT', 'active');
}
$Active_Management = defined('ACTIVE_MANAGEMENT') ? ACTIVE_MANAGEMENT : '';
                    ...
                    <div class="container-fluid">
                        ...
                        ">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sql = "SELECT * FROM tbl_user WHERE utype = '$d_s'";
