                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <?php
                                        include_once './add.section.d.php';
                                        ?>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <button type="button" class="btn btn-success waves-effect waves-light float-right" data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg" onclick="Add_sec(7)">Add Section</button>
                        ...
                        ">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sql = "SELECT * FROM tbl_sec_data WHERE secgrade = 7 ";
