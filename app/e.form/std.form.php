                            ...
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <div class="btn-group float-right">
                                        <ol class="breadcrumb hide-phone p-0 m-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="#">Enrollment form</a></li>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body">
                                                <button type="submit" class="btn btn-success waves-effect waves-light float-right" onclick="E_p()">
                                                    <i class=" fas fa-print "></i>
                                                </button>
                                                <h4 class="mt-0 header-title">Personal info.</h4>
                                                <p class="text-muted mb-4 font-13">You must update your personal details to ensure accuracy in generating an enrollment form and to avoid mistakes</p>
                                                <div class="row">
                                                    <div class="col-12">
                                                        <?php
                                                        require_once './u.data.php';
                                                        ?>
                                                    </div>
                                                </div>
                                            </div>
