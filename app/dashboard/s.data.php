...
$sqlGrade7 = "SELECT COUNT(*) AS total_grade7 FROM tbl_std_data WHERE genroll = 7";
...
$sqlGrade8 = "SELECT COUNT(*) AS total_grade8 FROM tbl_std_data WHERE genroll = 8";
...
$sqlGrade9 = "SELECT COUNT(*) AS total_grade9 FROM tbl_std_data WHERE genroll = 9";
...
$sqlGrade10 = "SELECT COUNT(*) AS total_grade10 FROM tbl_std_data WHERE genroll = 10";
...
$sqlGrade11 = "SELECT COUNT(*) AS total_grade11 FROM tbl_std_data WHERE genroll = 11";
...
$sqlGrade12 = "SELECT COUNT(*) AS total_grade12 FROM tbl_std_data WHERE genroll = 12";
