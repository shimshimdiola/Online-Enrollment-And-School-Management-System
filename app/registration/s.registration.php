...
if ($current_file == 's.registration.php') {
...
<body class="fixed-left">
    ...
    <div id="wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        ">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $glvl = isset($_GET['glvl']) ? $_GET['glvl'] : ''; // Assuming it's coming from a GET request

                                                            // Validate and sanitize $glvl to prevent SQL injection
                                                            $glvl = mysqli_real_escape_string($conn, $glvl);
        ...
        WHERE tbl_std_data.genroll = ?';
                                                            ...
                                                            mysqli_stmt_bind_param($stmt, "i", $glvl); // Assuming genroll is an integer, adjust "i" if it's a different data type
