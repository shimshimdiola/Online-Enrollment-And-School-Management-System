                    ...
                    <div class="container-fluid">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <button type="button" class="btn btn-success waves-effect waves-light float-right" data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg" onclick="Add_sub(<?php echo $sub_s ?>)">Add subject</button>
                        ...
                        ">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sql = "SELECT * FROM tbl_sub_data WHERE subg = '$sub_s'";
