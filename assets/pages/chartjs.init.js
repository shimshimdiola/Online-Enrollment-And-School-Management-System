...
var myChart = new Chart(ctx, {
    ...
    options: {
      legend: { position: "bottom", display: !0, labels: { boxWidth: 12 } },
      tooltips: { displayColors: !0, intersect: !0 },
      ...
      scales: {
        ...
        yAxes: [{ ticks: { display: !0, fontFamily: "'Rubik', sans-serif" } }],
      },
    },
  }),
  gradientStroke6 = (ctx = document
    .getElementById("dash-pie")
...
myChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [
      {
        backgroundColor: [gradientStroke9, gradientStroke10, gradientStroke11],
        hoverBackgroundColor: [
          gradientStroke9,
          gradientStroke10,
          gradientStroke11,
...
var gradientStroke12 = (ctx = document
  ...
  options: {
    ...
    scales: {
      xAxes: [
        {
          ticks: { max: 100, min: 20, stepSize: 10 },
          gridLines: { display: !0, color: "#FFFFFF" },
          ticks: { display: !0, fontFamily: "'Rubik', sans-serif" },
        },
      ],
      yAxes: [
        {
          gridLines: { color: "#fff", display: !0 },
          ticks: { display: !0, fontFamily: "'Rubik', sans-serif" },
        },
      ],
    },
...
(gradientStroke13 = (ctx = document
  ...
  (gradientStroke14 = ctx.createLinearGradient(0, 0, 0, 300)).addColorStop(
    0,
    "#4776e6"
  ),
  gradientStroke14.addColorStop(1, "#8e54e9"),
  (gradientStroke15 = ctx.createLinearGradient(0, 0, 0, 300)).addColorStop(
    0,
    "#ee0979"
  ),
  gradientStroke15.addColorStop(1, "#ff6a00");
var gradientStroke13, gradientStroke14, gradientStroke15;
myChart = new Chart(ctx, {
  type: "polarArea",
  data: {
    ...
    datasets: [
      {
        backgroundColor: [gradientStroke13, gradientStroke14, gradientStroke15],
        hoverBackgroundColor: [
          gradientStroke13,
          gradientStroke14,
          gradientStroke15,
  ...
  options: {
    legend: { display: !0, position: "bottom", labels: { boxWidth: 12 } },
    scale: { gridLines: { color: "rgba(221, 221, 221, 0.9)" } },
  },
});
(gradientStroke13 = (ctx = document
