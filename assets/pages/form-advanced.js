!(function (t) {
  ...
  (e.prototype.init = function () {
    t(".colorpicker-default").colorpicker({ format: "hex" }),
      ...
      t("#mdate").bootstrapMaterialDatePicker({ weekStart: 0, time: !1 }),
      ...
      t(".colorpicker").asColorPicker(),
      t(".gradient-colorpicker").asColorPicker({ mode: "gradient" }),
      t(".complex-colorpicker").asColorPicker({ mode: "complex" }),
      t(".select2").select2({ width: "100%" });
  }),
